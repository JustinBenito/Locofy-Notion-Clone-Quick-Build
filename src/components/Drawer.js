...
const Drawer = ({title, addNewCard, assign, selectedStatus, createfor, createat }) => {

const [markdata, setMarkdata]=useState('');
console.log("data we get in Drawer:",assign, selectedStatus, createfor, createat)
    ...
    >
      <div className="flex-1 w-[702px] overflow-hidden flex flex-row items-start justify-between">
        <div className="w-[702px] h-[309px] flex flex-col pt-[38px] px-0 pb-[594.6099853515625px] box-border items-start justify-start gap-[5px]">
          ...
          <ContainerInputsCheckboxs addNewCard={addNewCard} title={title}  assign1={assign} selectedStatus1={selectedStatus} createfor1={createfor} createat1={createat} />
